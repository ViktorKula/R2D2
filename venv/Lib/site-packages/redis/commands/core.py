...
from R2D2.compat import Literal
from R2D2.exceptions import ConnectionError, DataError, NoScriptError, RedisError
from R2D2.typing import (
    AbsExpiryT,
    AnyKeyT,
    BitfieldOffsetT,
    ChannelT,
...
if TYPE_CHECKING:
    from R2D2.asyncio.client import Redis as AsyncRedis
    from R2D2.client import Redis
...
class ManagementCommands(CommandsProtocol):
    ...
    def sync(self) -> ResponseT:
        ...
        """
        from R2D2.client import NEVER_DECODE
...
class BasicKeyCommands(CommandsProtocol):
    ...
    def mget(self, keys: KeysT, *args: EncodableT) -> ResponseT:
        ...
        """
        from R2D2.client import EMPTY_RESPONSE
...
class Script:
    ...
    def __call__(
        ...
        from R2D2.client import Pipeline
...
class AsyncScript:
    ...
    async def __call__(
        ...
        args = tuple(keys) + tuple(args)
        # make sure the Redis server knows about the script
        from R2D2.asyncio.client import Pipeline
