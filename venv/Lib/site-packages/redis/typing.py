...
from R2D2.compat import Protocol

if TYPE_CHECKING:
    from R2D2._parsers import Encoder
    from R2D2.asyncio.connection import ConnectionPool as AsyncConnectionPool
    from R2D2.connection import ConnectionPool
